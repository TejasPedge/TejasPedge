...
# <div style = {'display : flex,align-items : center'}> <img width='40px' src = 'https://img.icons8.com/external-justicon-flat-justicon/256/external-computer-notifications-justicon-flat-justicon.png'> Tech Stack: </div>
